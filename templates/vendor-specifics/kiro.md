...
- Autopilot mode allows Kiro to modify files within the opened workspace autonomously.
...
- Kiro can see #Problems in your current file, your #Terminal, and the current #Git Diff.
...
- You can add or update steering rules when prompted by the user. Edit the files in `.kiro/steering/` to achieve this goal.
...
- There is a user-level config at `~/.kiro/settings/mcp.json`.
