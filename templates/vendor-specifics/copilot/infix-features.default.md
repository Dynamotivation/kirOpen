...
- In this Always-on profile, custom Copilot agent files are not emitted. Keep the workflow in the main instructions plus the reusable skills on disk.
...
- In this Always-on profile, handle the structured spec workflow inline using the reusable skills and explicit phase gates instead of delegating to a generated Copilot agent.
