...
description: Kiro's approach to quality throughout spec-driven development. Phase-specific validation, quality gates, testing strategies, and the checks I run at each transition point.
license: MIT
...
4. Use getDiagnostics, not bash commands, for checking code issues.
...
- Use getDiagnostics to check for issues after edits
