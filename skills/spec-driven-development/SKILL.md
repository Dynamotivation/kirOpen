...
description: Kiro's three-phase approach to feature development — Requirements, Design, Tasks. Transforms vague ideas into implementable solutions through structured planning that reduces ambiguity and enables effective AI collaboration.
license: MIT
...
The output is a `requirements.md` with:
...
Once requirements are solid, I create a `design.md` covering:
...
Design gets broken into a `tasks.md` — a sequenced implementation plan:
