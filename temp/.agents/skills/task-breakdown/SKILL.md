---
name: task-breakdown
description: KirOpen's approach to converting technical designs into sequenced, actionable implementation tasks. Creates clear coding tasks that respect dependencies, enable incremental progress, and maintain traceability to requirements.
license: MIT
